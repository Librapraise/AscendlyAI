...
export default function Sidebar({ isOpen, setIsOpen, onLogout, user }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`fixed left-0 top-0 z-30 w-70 h-full bg-gray-800 transform transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
